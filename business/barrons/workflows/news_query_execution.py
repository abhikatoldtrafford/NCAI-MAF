...
from infrastructure.data.plugins.SDL_plugin import SDLQueryPlugin
...
class NewsQueryWorkflow(WorkflowInterface[str, str]):
    ...
    async def _fetch_articles(self, search_terms: str) -> list:
        ...
        SDL_endpoint = aws_creds["SDL_URL"]
        SDL_okta_issuer = aws_creds["OKTA_SDL_AUTH_ISSUER"]
        SDL_okta_client_secret = aws_creds["OKTA_SDL_AUTH_CLIENT_SECRET"]
        SDL_okta_client_ID = aws_creds["OKTA_SDL_AUTH_CLIENT_ID"]
        logging = None
