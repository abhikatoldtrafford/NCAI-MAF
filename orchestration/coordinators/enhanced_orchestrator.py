...
from infrastructure.conversation.conversation_store import ConversationStore
...
class EnhancedOrchestrator:
    ...
    async def process_prompt_with_streaming(
        ...
        if parameters.get("include_conversation_history", True):
            conversation_context = self.conversation_store.format_for_prompt(
                conversation_id=conversation_id,
            ...
            if conversation_context:
                ...
                if system_prompt_text:
                    ...
                    system_prompt_text = f"You are a helpful assistant.\n\n{conversation_context}"
        ...
        try:
            ...
            # # If we have parallel workflows and streaming is enabled
            # if is_streaming and workflow_info.get("parallel") and callback:
            #     # Execute all workflows in parallel with streaming
            #     return await self._execute_parallel_workflows_streaming(
    ...
    async def _execute_parallel_workflows_streaming(
        ...
        for i, result in enumerate(results):
            ...
            # Handle error
                ...
                final_result["workflows"][workflow_id] = {
                    "status": "failed",
                    "error": error_msg
                }
